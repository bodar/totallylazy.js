...
import {
    ...
    atBoundaryOnly, decimalSeparator, inferDecimalSeparator,
    mapIgnoreError,
    separatorsOf
} from "../parsing";
...
import {first} from "../../transducers/first";
import {flatMap} from "../../transducers/flatMap";
import {filter} from "../../transducers/filter";
import {find} from "../../transducers/find";
import {sort} from "../../transducers/sort";
import {Parser} from "../parser";
import {FailParser} from "../failParser";
import {infer} from "../strategy/infer";
import {MatchStrategy} from "../strategy/matchStrategy";
import {Spaces} from "../spaces";
import {NumberParser, numberParser} from "../numberParser";
import {numberPattern} from "../numerals";
